...
# Tyto třídy pro reprezentaci zřetězeného seznamu máte již připraveny.
# Nijak je nemodifikujte.
...
# Pro naprogramování této funkce Vám postačuje jeden průchod vstupním seznamem.
#
